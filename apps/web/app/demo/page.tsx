...
authentication. Test the three core API endpoints that
demonstrate academic REST principles.
  </Text>
...
<Text size='sm' c='dimmed'>
  ...
  filtering. Requires JWT authentication and validates
  profile ownership.
</Text>
{apiResults.names && (
...
<Text size='sm' c='dimmed'>
  Manages consent lifecycle: request, grant, or revoke
  consent between users. Demonstrates comprehensive input
...
(GET/POST), status codes, and resource URLs
  ...
  <Text size='sm'>
• <strong>JWT Authentication</strong>: Bearer token
...
secure access patterns. Please sign in to test the interactive
API functionality.
  </Text>
</Alert>
  )}
...
<Stack gap='xs'>
  <Text size='sm'>
• <strong>Context Engine</strong>: The{' '}
<Code>resolve_name()</Code> function checks user consent and
name visibility
  </Text>
  <Text size='sm'>
...
can see which names
  ...
  <Text size='sm'>
• <strong>Prioritized</strong>: preferred &gt; nickname &gt;
legal &gt; alias based on context appropriateness
  </Text>
  {currentUser && (
