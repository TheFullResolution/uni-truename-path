...
<Alert color='blue' title='Academic Project Demo'>
  This demonstrates the core TrueNamePath concept:{' '}
  <strong>right name, right audience, right time</strong>. Each persona
  has different name variants with different visibility and consent
  settings.
</Alert>
...
Click each button to see what name this persona shows to different
audiences:
  </Text>
