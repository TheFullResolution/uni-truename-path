 ...
 */
export type ExtractSuccessData<T> = T extends StandardSuccessResponse<infer U> ? U : never;

/**
 * Common response types for TrueNamePath API endpoints
 * These provide type safety for specific endpoint responses
 */
...
message: string;
  ...
  /**
   * Generic ID response (for resource creation)
   */
